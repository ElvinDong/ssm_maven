...
Source Database       : ssm_maven

Target Server Type    : MYSQL
Target Server Version : 50719
File Encoding         : 65001

Date: 2019-08-30 16:37:53
*/
...
CREATE TABLE `tb_order` (
  ...
  CONSTRAINT `tb_order_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tb_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `tb_orderdetail` (
  ...
  CONSTRAINT `tb_orderdetail_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `tb_order` (`id`),
  CONSTRAINT `tb_orderdetail_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `tb_item` (`id`)
...
INSERT INTO `tb_user` VALUES ('8', null, null, null, null, null, null, '2019-08-30 16:13:05', null);
